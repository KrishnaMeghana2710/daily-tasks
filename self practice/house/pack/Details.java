...
public class Details {
    public static void main(String[] args) {
        ...
        System.out.println("Banks that provide loan to the buy an apartment are "+details.banks());

        details = new Villa();
        System.out.println("\nPrice of a villa is "+details.getPrice());
        System.out.println("Banks that provide loans to get a villa are "+details.banks());

        details = new Plot();
        System.out.println("\nThe price of a plot is "+details.getPrice());
        System.out.println("Banks that provide loans to get a plot are "+details.banks());
